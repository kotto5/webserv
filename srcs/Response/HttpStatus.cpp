 ...
 * @return 対応表
 */
std::map<std::string, std::string> createHttpStatusMap()
{
	std::map<std::string, std::string> httpStatus;
...
const std::map<std::string, std::string> HttpStatus::HTTP_STATUS = createHttpStatusMap();
